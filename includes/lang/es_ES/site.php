...
define('REGISTRATION_MESSAGE_SUCCESS', '<div class="success-response"><h1><i class="icon-film"></i></h1><h3>¡Bien!</h3><h2>te has registrado con éxito</h2><h4>Revisa tu bandeja de correo y sigue las instrucciones que te hemos enviado para poder entrar al sistema</h4></div>');
